...
<?php
		...
		$sql_pesquisa = "select max(boletim) as ultimo from financeiro where ano =$ano";
	...
	<body>
		<div width="500" height="50">
			...
			<fieldset >
				<legend align='center'>Adicionar Boletim do <font size="5" color="red">Financeiro</font></legend>
	...
	<div width="500" height="50">
			...
			<fieldset >
				<legend align='center'>Excluir boletim do Financeiro</legend>
					<table border=1  align="center">
						<tr>
							<td align="center">
