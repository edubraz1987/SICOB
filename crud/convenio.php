...
<?php
		...
		$sql_pesquisa = "select max(boletim) as ultimo from convenio where ano =$ano";
	...
	<body>
		<div width="500" height="50">
			...
			<fieldset >
				<legend align='center'>Adicionar Boletim do <font size="5" color="red">Convênio</font></legend>
	...
	<div width="500" height="50">
			...
			<fieldset >
				<legend align='center'>Excluir boletim do Convênio</legend>
					<table border=1  align="center">
						<tr>
							<td align="center">
